...
project_id = 'circular-study-447119-q1'
dataset_id = 'staging_dataset'
transform_dataset_id = 'transform_dataset'
reporting_dataset_id = 'reporting_dst'
source_table = f'{project_id}.{dataset_id}.global_data'  # Main table loaded from CSV
countries = ['USA', 'UK', 'India', 'Germany', 'Japan', 'France', 'Canada', 'Italy']  # Country-specific tables to be created
# DAG definition
with DAG(
    ...
    check_file_exists = GCSObjectExistenceSensor(
        ...
        bucket='bkt-src-dta',  # Replace with your bucket name
